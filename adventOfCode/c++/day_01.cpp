...
int main() {
  ...
  int entry[n_entry] = {
      1974, 1902, 1356, 1724, 1550, 1870, 1436, 1945, 1640, 1766, 1508, 1802,
  ...
  // std::cout << "Result with 2 numbers is: " << sum_with_2(n_entry, entry) <<
  // std::endl;
  std::cout << "Result with 3 numbers is: " << sum_with_3(n_entry, entry)
            << std::endl;
}
